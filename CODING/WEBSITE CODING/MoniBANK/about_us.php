...
<head>
    ...
    <link rel="logo" sizes="180x180" href="statics/logo.png">
...
<body style="background-color:#212529;">
            ...
            <b>
                ...
                <li class="nav-item nav-links" style="margin-left:15px;">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap" href="withdraw.php">Withdraw Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="send.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link active text-nowrap" aria-current="page" href="about_us.php">About Us</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/logo.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Monisha, Reshma</h1>
            <p style="color:gray;"><b>Prince Dr K Vasudevan College Of Engineering and Technology, Chennai <br>done as a part of final year project </b></p>
    </center>

...
<head>
    ...
    <link rel="banklogo" sizes="180x180" href="statics/logo.png">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> SMART CARD SERVICES!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/fin.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <a href="withdraw.php"><button type="button" class="btn btn-outline-light mybtn">Withdraw Money</button></a><br>
                            <h6>Here, you can withdraw money from your bank account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div

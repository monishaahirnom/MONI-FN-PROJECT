...
if strcmp(p,'123') == 1
    ...
    msgbox('Make sure you read the "HELP" before you start','HELP....!!!','help','modal')
...
% --------------------------------------------------------------------
function AD_NW_IMAGE_Callback(hObject, eventdata, ~)
...
if exist('features.mat','file') == 2
    bx = questdlg({'TRAINING HAS ALREADY BEEN DONE';' ';'WANT TO TRAIN DATABASE AGAIN?'},'SELECT','YES','NO','CC');
    if strcmpi(bx,'yes') == 1
        builddatabase
